...
public class HealthCondition {
    ...
    public HealthCondition(Long health_id, Timestamp timestamp, String blood_pressure, String heart_rate, String anxiety_level, String cholesterol_level, String blood_sugar_level, Float weight, Float height, Report report, User user) {
